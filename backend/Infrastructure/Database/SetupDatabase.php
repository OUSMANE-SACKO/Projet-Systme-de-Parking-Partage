...
class SetupDatabase {
    ...
    public function run(): void {
        ...
        // Table des grilles tarifaires (tarifs progressifs basés sur le temps)
        $pdo->exec("
            CREATE TABLE IF NOT EXISTS pricing_tiers (
                id INT AUTO_INCREMENT PRIMARY KEY,
                parking_id INT NOT NULL,
                time TIME NOT NULL COMMENT 'Heure à partir de laquelle ce tarif s applique',
                price DECIMAL(10, 2) NOT NULL COMMENT 'Prix horaire pour cette tranche',
                FOREIGN KEY (parking_id) REFERENCES parkings(id) ON DELETE CASCADE
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
        ");
        ...
        $pdo->exec("
            CREATE TABLE IF NOT EXISTS subscription_types (
                ...
                duration_months INT NOT NULL DEFAULT 1 COMMENT 'Durée de l abonnement en mois',
                FOREIGN KEY (parking_id) REFERENCES parkings(id) ON DELETE CASCADE
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
        ");
